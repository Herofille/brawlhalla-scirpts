package
{
   public class §_-h4e§
   {
      ...
      public static var §_-k5i§:Array = [16777215,16776960,16750848,16711680,12517376,9175040,4849664];
      ...
      public function §_-J31§(param1:int, param2:uint = 0) : void
      {
         ...
         var _loc8_:Boolean = (param2 & §_-h4e§.KO) != 0;
         var _loc9_:Boolean = (param2 & §_-h4e§.HIT) != 0;
