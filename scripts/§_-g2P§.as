package
{
   ...
   public class §_-g2P§
   {
      ...
      public function §_-g2P§(param1:§_-D4e§, param2:uint)
      {
         mScreen = param1;
         §_-B2X§(mScreen.§_-u56§);
         ...
         §_-Dl§ = new §_-F11§(§_-k2A§,§_-s2J§.§_-N3v§(§_-95E§.§_-gG§,"am_PaperDollBuddy"),null,0,0,null,0);
         §_-Dl§.§_-uZ§();
      ...
      {
         if(§_-e5Q§ && !§_-g2P§.§_-v59§ && (§_-11v§ != null || §_-p1L§ != null || §_-Q2K§ != null || §_-n2Y§ != null))
         {
      ...
      public function §_-457§(param1:§_-a5§, param2:Number, param3:Number, param4:Number, param5:HeroType = undefined) : void
      {
         var _loc8_:* = null as §_-O37§;
         var _loc9_:* = null as CostumeType;
         var _loc10_:* = null as §_-x2O§;
         var _loc11_:* = null as §_-83D§;
         var _loc12_:* = null as §_-n8§;
         ...
         {
            if(param1.§_-81j§ != null)
            {
               §_-W2A§(param1.§_-81j§);
            }
            if(param1.mSigSwapImage1 != null && param1.mSigSwapImage2 != null)
            {
               §_-V4V§(param1.mSigSwapImage1,param1.mSigSwapImage2,param1.§_-S3Z§);
            }
            _loc9_ = CostumeType.§_-g2W§(param1.§_-l1r§);
            §_-aB§(_loc9_);
            if(_loc9_.§_-m4E§.mHeroName == "Soldier")
            {
               §_-J39§.§_-w1j§(§_-J39§.§_-o2A§ - 50,§_-J39§.§_-24b§);
            }
            if(§_-e5Q§ && _loc9_.§_-P4L§ != null)
            {
               §_-11v§ = _loc9_;
               §_-S5K§ = §_-k2A§.§_-v57§;
               §_-F5o§ = 2500;
            ...
            if(§_-03F§ != null)
            {
               _loc9_.§_-m4E§.§_-t3u§(§_-k2A§,_loc9_,§_-03F§);
            }
         }
         else if(_loc7_ == "KOEffect")
         {
            _loc10_ = §_-x2O§.§_-b41§(param1.§_-l1r§);
            §_-F11§.§_-V5S§(§_-J39§,_loc10_);
            §_-w2S§(_loc10_.mDisplayNameKey);
            if(§_-03F§ != null)
            {
               _loc10_.§_-616§(§_-k2A§,§_-03F§);
            }
         }
         else if(_loc7_ == "PlayerTheme")
         {
            §_-J39§.§_-w1j§(§_-J39§.§_-o2A§ - 30,§_-J39§.§_-24b§);
            _loc11_ = §_-83D§.§_-V4e§(param1.§_-l1r§);
            §_-F11§.§_-65A§(§_-J39§,_loc11_,"StoreAllItems");
            §_-w2S§(_loc11_.mDisplayNameKey);
         }
         else if(_loc7_ == "Podium")
         {
            _loc12_ = §_-n8§.§_-p4H§(param1.§_-l1r§);
            §_-71c§(_loc12_);
            if(§_-e5Q§ && _loc12_.§_-P4L§ != null)
            {
               §_-p1L§ = _loc12_;
               §_-S5K§ = §_-k2A§.§_-v57§;
               §_-F5o§ = 3000;
         ...
         {
            _loc13_ = §_-16C§.§_-m5g§(param1.§_-l1r§);
            §_-B4§(§_-J39§,_loc13_,param5);
         }
         else if(_loc7_ == "SpawnBot")
         {
            _loc14_ = §_-A5q§.§_-W3M§(param1.§_-l1r§);
            §_-F11§.§_-U3e§(§_-J39§,_loc14_,"Ready");
            §_-w2S§(_loc14_.mDisplayNameKey);
         }
         else if(_loc7_ == "Taunt")
         {
            §_-L4j§(§_-Dl§,param2,param3,param4);
            _loc15_ = §_-c2§.§_-c2K§.get(param1.§_-l1r§);
            §_-F11§.§_-Y4E§(§_-J39§,_loc15_,1,CostumeType.§_-Fp§,null,null,true,true);
            _loc16_ = §_-Io§.§_-T5N§(_loc15_.§_-w3R§);
            _loc17_ = _loc16_.§_-y1R§;
            if(_loc17_)
            {
               §_-n2Y§ = _loc15_;
               §_-S5K§ = §_-k2A§.§_-v57§;
            ...
            if(§_-03F§ != null)
            {
               _loc15_.§_-vL§(§_-k2A§,false,§_-03F§);
            }
         }
         ...
         {
            _loc18_ = §_-M1H§.§_-F1Y§(param1.§_-l1r§);
            §_-F11§.§_-j29§(§_-J39§,_loc18_);
            §_-w2S§(_loc18_.mDisplayNameKey);
            §_-a4B§(param1.§_-K51§(),§_-w1D§.§_-Y§(§_-M1H§.§_-iK§(_loc18_.§_-n2o§)) + " ");
         }
      }
      
      public function §_-h5w§(param1:§_-a5§, param2:Number, param3:Number, param4:Number) : void
      {
         §_-G59§(param1.mType,param1.§_-l1r§,param1.§_-F4G§,param1.§_-d15§,"UI_BattlePass",param2,param3,param4);
      }
      ...
      public function §_-G59§(param1:String, param2:String, param3:uint, param4:String, param5:String, param6:Number, param7:Number, param8:Number) : void
      {
         ...
         {
            _loc10_ = CutsceneType.§_-112§.get(param2).mDisplayNameKey;
         }
      ...
      public function §_-X4n§(param1:§_-a5§, param2:Number, param3:Number, param4:Number) : void
      {
      ...
      public function §_-A16§(param1:§_-a5§, param2:Number, param3:Number, param4:Number) : void
      {
      ...
      public function §_-F2w§(param1:StoreType = undefined, param2:§_-j1F§ = undefined) : void
      {
         var _loc7_:* = null as StringMap;
         var _loc14_:* = null as CostumeType;
         var _loc15_:* = null as §_-n8§;
         var _loc16_:* = null as §_-EK§;
         ...
         var _loc4_:String = param1 != null ? param1.§_-l1r§ : param2.§_-l1r§;
         ...
         §_-L4j§(§_-J39§,_loc8_,_loc9_,_loc10_);
         var _loc11_:String = null;
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_;
         if(_loc13_ == "Costume")
         {
            _loc14_ = CostumeType.§_-g2W§(_loc4_);
            if(_loc14_ != null)
            {
               if(_loc14_.§_-L5i§ != null)
               {
                  _loc11_ = "Upgrade";
               }
               _loc12_ = _loc14_.§_-P13§;
            }
            §_-aB§(_loc14_);
         }
         else if(_loc13_ == "Podium")
         {
            _loc15_ = §_-n8§.§_-p4H§(_loc4_);
            if(_loc15_ != null && _loc15_.§_-L5i§ != null)
            {
               _loc11_ = "Upgrade";
            }
            §_-71c§(_loc15_);
         ...
         else
         {
            if(_loc13_ != "Moniker")
            {
               if(_loc13_ != "RankedSeasonMoniker")
               {
                  ...
                  {
                     _loc17_ = §_-16C§.§_-m5g§(_loc4_);
                     if(_loc17_ != null)
                     {
                        §_-G59§(_loc3_,_loc4_,0,_loc17_.§_-p19§,_loc17_.§_-V3F§,_loc8_,_loc9_,_loc10_);
                     }
                  }
               }
            }
            _loc16_ = _loc3_ == "RankedSeasonMoniker" ? §_-EK§.§_-w59§.get("S" + ("" + §_-s2J§.§_-01W§) + _loc4_) : §_-EK§.§_-w59§.get(_loc4_);
            if(_loc16_ != null && §_-M2j§ != null)
            {
               §_-M2j§.§_-c13§(_loc16_.§_-61V§);
               §_-M2j§.§_-k3N§(_loc16_.mDisplayNameKey);
               §_-w2S§(_loc16_.§_-W36§);
            }
         }
         _loc13_ = param1 != null ? param1.§_-C2h§ : StoreType.§_-gQ§(_loc3_,_loc4_,_loc12_,_loc11_);
         if(_loc13_ == null)
         {
      ...
      public function §_-Zo§(param1:§_-a5§, param2:HeroType = undefined) : void
      {
         ...
         §_-N3q§ = param1.§_-U1t§;
         var _loc3_:Boolean = param1.§_-p25§ <= §_-k2A§.§_-MN§.§_-Ru§ && (param1.§_-c3§ || §_-k2A§.§_-MN§.§_-6R§);
         if(!_loc3_ && param2 == null && param1.mType == "RandomColor" && §_-Q2K§ != null && §_-Q2K§.mColorSchemeName == param1.§_-l1r§)
         {
            return;
         }
         Clear(false);
         var _loc4_:String = param1.§_-K51§();
         if(_loc4_ == null)
         {
            _loc4_ = "Empty_String";
         }
         §_-a4B§(_loc4_,param1.§_-S3Z§ != null ? §_-w1D§.§_-Y§(param1.§_-Eq§()) + " " : null,param1.mType == "Cutscene" ? " " + §_-C2e§.§_-v19§(uint(§_-a5§.§_-Bu§.get(param1.§_-U1t§) + 1)) : null);
         ...
         var _loc8_:Number = _loc5_.x + param1.§_-ZR§;
         var _loc9_:Number = _loc5_.y + param1.§_-Q38§;
         var _loc10_:Number = _loc5_.z * param1.§_-G2h§;
         if(_loc10_ < 0.1)
         {
            _loc10_ = 0.1;
         }
         ...
         if(_loc11_ == "Avatar")
         {
            §_-A16§(param1,_loc8_,_loc9_,_loc10_);
         }
         else if(_loc11_ == "Emoji")
         {
            §_-X4n§(param1,_loc8_,_loc9_,_loc10_);
         }
         else
         {
                     ...
                     if(_loc11_ != "Mission")
                     {
                        if(_loc11_ != "Moniker")
                        {
                           if(_loc11_ == "RandomColor")
                           {
                              ...
                              {
                                 §_-457§(param1,_loc8_,_loc9_,_loc10_,param2);
                              }
                           }
                           else if(_loc11_ == "UniversalColor")
                           {
                              §_-457§(param1,_loc8_,_loc9_ - 100,_loc10_,param2);
                           }
                           else
                           {
                              §_-457§(param1,_loc8_,_loc9_,_loc10_,param2);
            ...
            §_-G59§(param1.mType,param1.§_-l1r§,param1.§_-F4G§,param1.§_-d15§,"UI_BattlePass",_loc8_,_loc9_,_loc10_);
            if(param1.mType == "Cutscene" && _loc3_)
            {
               §_-a4E§ = CutsceneType.§_-112§.get(param1.§_-l1r§);
               §_-P1r§.visible = true;
               §_-lD§.§_-H35§(true);
               §_-lD§.§_-k3N§("UI_BattlePass_ViewCutscene");
            }
         }
      }
      ...
      public function §_-j2r§(param1:§_-a5§) : void
      {
