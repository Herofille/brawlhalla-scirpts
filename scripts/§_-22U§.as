package
{
   ...
   public class §_-22U§ extends §_-D4e§
   {
      ...
      public static var §_-v5M§:Array = [16777215,16776960,16750848,16711680,12517376,9175040,4849664];
      ...
      override public function §_-M3o§() : void
      {
         ...
         if(§_-k2A§.§_-b42§ != null)
         {
            ...
            §_-22U§.§_-Y28§ = (§_-k2A§.§_-b42§.§_-X1f§ & 0x0200) != 0;
            if(§_-k2A§.§_-u2A§ != 0)
            {
      ...
      override public function §_-GV§() : void
      {
         ...
         if((_loc5_.§_-d3H§ & 0x400006) == 0 && (_loc5_.§_-d3H§ & 0x2009) == 0)
         {
