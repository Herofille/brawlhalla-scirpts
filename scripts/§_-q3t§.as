package
{
   ...
   public class §_-q3t§
   {
      ...
      public function §_-q3t§()
      {
      }
      
      public static function §_-n4V§(param1:Matrix, param2:Number, param3:Number, param4:Point = undefined) : Point
      {
         if(param4 == null)
         {
            param4 = new Point();
      ...
      public static function §_-J14§(param1:Matrix, param2:Number, param3:Number) : void
      {
      ...
      public static function §_-z3s§(param1:Matrix, param2:Matrix) : void
      {
