package
{
   public class §_-s4d§
   {
      ...
      public var mCache:Vector.<§_-339§> = new Vector.<§_-339§>();
      
      public function §_-s4d§()
      {
         §_-e5E§();
      }
      
      public function Store(param1:§_-339§, param2:int = -1) : int
      {
         var _loc3_:* = null as §_-339§;
         if(param2 >= 0)
         {
            _loc3_ = §_-k4v§(param2);
      ...
      {
         var _loc2_:§_-339§ = mCache[param1];
         if(_loc2_ != null)
         {
            --§_-m2i§;
      ...
      public function §_-k1i§(param1:int, param2:Boolean = true) : Boolean
      {
         ...
         var _loc3_:§_-339§ = mCache[param1];
         if(_loc3_ == null || !_loc3_.CanPrune(param2))
         {
            return false;
         }
         var _loc4_:§_-339§ = mCache[param1];
         if(_loc4_ != null)
         {
            --§_-m2i§;
      ...
      public function §_-u4C§(param1:int, param2:Boolean) : int
      {
         ...
         var _loc10_:* = null as §_-339§;
         var _loc11_:* = null as §_-339§;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
      ...
      public function §_-k4v§(param1:int) : §_-339§
      {
         if(param1 < 0 || param1 >= int(mCache.length))
         {
            return null;
