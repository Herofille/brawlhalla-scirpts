package
{
   ...
   public class §_-U2u§
   {
         ...
         while(_loc2_ < _loc3_)
         {
            ...
            if(!_loc5_.§_-IV§)
            {
               ...
               else if(_loc6_ != _loc7_)
               {
                  _loc8_ = §_-k2A§;
                  _loc9_ = 16777216;
                  if((_loc8_.§_-d3H§ & _loc9_) != 0 || (_loc8_.§_-d3H§ & 0x20) != 0 && (_loc8_.§_-i1M§ & _loc9_) != 0)
                  {
      ...
      public function §_-A2C§(param1:uint, param2:§_-j53§, param3:Number, param4:Point, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         {
            _loc10_ = int(uint(param1 - (uint(param2.§_-L51§ + 32))));
      ...
      public function §_-V4j§(param1:uint, param2:§_-Io§, param3:§_-43v§, param4:uint, param5:§_-j53§, param6:§_-j53§, param7:Point, param8:uint, param9:uint, param10:uint, param11:Number, param12:Number, param13:Boolean, param14:Boolean, param15:uint, param16:uint, param17:§_-Io§, param18:Boolean, param19:Boolean, param20:uint, param21:Boolean) : void
      {
         ...
         var _loc26_:Boolean = param6.§_-u2R§() || uint(param6.§_-L51§ + 32) >= param1;
         ...
         var _loc29_:uint = uint(uint(10 + param5.§_-R5d§) - param6.§_-d3v§);
         ...
         if(_loc38_)
         {
            ...
            {
               _loc39_ = (param6.§_-qj§.§_-l3y§ & 0x0F) != 0;
            }
            else
            {
               _loc39_ = false;
         ...
         {
            _loc48_ = §_-k2A§.§_-3A§ != null && (§_-k2A§.§_-d3H§ & 0x400006) != 0;
            _loc49_ = §_-f2T§.§_-e1Z§;
            if(param2 != null)
            {
               if(_loc45_)
            ...
            if(_loc33_ != null && (!§_-T1S§.§_-eN§ && §_-T1S§.§_-43F§ && !§_-T1S§.§_-v54§))
            {
               ...
               _loc50_ = uint(param5.§_-k2A§.§_-m5s§ == param5 ? §_-f2T§.§_-O0§ : int(4294967295));
