package
{
   ...
   public class §_-D4U§
   {
      ...
      public static var §_-o2O§:Array = [0,1996959894,-301047508,-1727442502,124634137,1886057615,-379345611,-1637575261,249268274,2044508324,-522852066,-1747789432,162941995,2125561021,-407360249,-1866523247,498536548,1789927666,-205950648,-2067906082,450548861,1843258603,-187386543,-2083289657,325883990,1684777152,-43845254,-1973040660,335633487,1661365465,-99664541,-1928851979,997073096,1281953886,-715111964,-1570279054,1006888145,1258607687,-770865667,-1526024853,901097722,1119000684,-608450090,-1396901568,853044451,1172266101,-589951537,-1412350631,651767980,1373503546,-925412992,-1076862698,565507253,1454621731,-809855591,-1195530993,671266974,1594198024,-972236366,-1324619484,795835527,1483230225,-1050600021,-1234817731,1994146192,31158534,-1731059524,-271249366,1907459465,112637215,-1614814043,-390540237,2013776290,251722036,-1777751922,-519137256,2137656763,141376813,-1855689577,-429695999,1802195444,476864866,-2056965928,-228458418,1812370925,453092731,-2113342271,-183516073,1706088902
      ...
      public function §_-D4U§()
      {
      }
      
      public static function §_-i3y§(param1:BitmapData, param2:int = 0, param3:int = 0, param4:int = 0, param5:int = 0) : ByteArray
      {
         var _loc15_:int = 0;
         ...
         _loc9_.writeByte(0);
         §_-D4U§.§_-q3i§(_loc6_,1229472850,_loc9_);
         var _loc10_:* = 0;
         ...
         _loc11_.compress();
         §_-D4U§.§_-q3i§(_loc6_,1229209940,_loc11_);
         §_-D4U§.§_-q3i§(_loc6_,1229278788,null);
         return _loc6_;
      }
      
      public static function §_-q3i§(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         var _loc11_:int = 0;
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         ...
         while(_loc9_ < _loc10_)
         {
            ...
            _loc7_ = uint(uint(§_-D4U§.§_-o2O§[_loc13_]) ^ uint(_loc7_ >>> 8));
         }
         _loc7_ ^= -1;
      ...
      public static function §_-F4m§(param1:uint, param2:uint, param3:uint, param4:BitmapData, param5:ByteArray) : ByteArray
      {
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         var _loc17_:int = 0;
         ...
         _loc6_.writeByte(0);
         §_-D4U§.§_-q3i§(param5,1229472850,_loc6_);
         var _loc7_:ByteArray = new ByteArray();
         _loc7_.writeUnsignedInt(uint(param1 + 0));
         _loc7_.writeUnsignedInt(0);
         §_-D4U§.§_-q3i§(param5,1633899596,_loc7_);
         var _loc8_:* = 0;
         var _loc9_:ByteArray = new ByteArray();
         ...
         _loc9_.compress();
         §_-D4U§.§_-q3i§(param5,1229209940,_loc9_);
         return param5;
      }
      
      public static function §_-w4l§(param1:ByteArray, param2:BitmapData, param3:uint, param4:uint, param5:uint, param6:Boolean = false) : void
      {
         var _loc17_:int = 0;
         var _loc18_:int = 0;
         var _loc19_:int = 0;
         ...
         _loc10_.writeByte(1);
         _loc10_.writeByte(0);
         §_-D4U§.§_-q3i§(param1,1717785676,_loc10_);
         var _loc11_:ByteArray = new ByteArray();
         ...
         §_-D4U§.§_-q3i§(param1,1717846356,_loc11_);
      }
      
      public static function §_-sT§(param1:ByteArray) : void
      {
         §_-D4U§.§_-q3i§(param1,1229278788,null);
      }
   }
}
