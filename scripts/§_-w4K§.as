package
{
   ...
   public class §_-w4K§
   {
      ...
      public static var §_-l11§:Sprite;
      
      public static var §_-CN§:Sprite;
      
      public static var §_-pq§:Sprite;
      
      public static var §_-03h§:Point;
      
      public static var sCommon128Canvas:§_-V2o§;
      
      public static var sCommon256Canvas:§_-V2o§;
      
      public static var sCommon512Canvas:§_-V2o§;
      
      public static var §_-x56§:§_-V2o§;
      
      public static var §_-t5R§:§_-V2o§;
      
      public static var §_-u5w§:int = 2;
      
      public function §_-w4K§()
      {
      }
      
      public static function §_-53N§(param1:uint, param2:uint) : BitmapData
      {
         if(§_-w4K§.sCommon128Canvas.§_-21w§(param1,param2))
         {
            return §_-w4K§.sCommon128Canvas.§_-L4q§(param1,param2);
         }
         if(§_-w4K§.sCommon256Canvas.§_-21w§(param1,param2))
         {
            return §_-w4K§.sCommon256Canvas.§_-L4q§(param1,param2);
         }
         if(§_-w4K§.§_-x56§.§_-21w§(param1,param2))
         {
            return §_-w4K§.§_-x56§.§_-L4q§(param1,param2);
         }
         if(§_-w4K§.sCommon512Canvas.§_-21w§(param1,param2))
         {
            return §_-w4K§.sCommon512Canvas.§_-L4q§(param1,param2);
         }
         if(uint(param2 * 4) <= param1)
         {
            return §_-w4K§.§_-x56§.§_-L4q§(param1,param2);
         }
         return §_-w4K§.§_-t5R§.§_-L4q§(param1,param2);
      }
      
      public static function §_-P5T§(param1:uint, param2:uint, param3:IMap) : uint
      {
      ...
      public static function §_-w1L§(param1:Sprite, param2:Number, param3:uint, param4:IMap, param5:uint, param6:Boolean, param7:Boolean = true) : Bitmap
      {
         ...
         {
            if(§_-w4K§.§_-l11§.numChildren > 0)
            {
               §_-w4K§.§_-l11§.removeChild(param1);
            }
            return null;
         }
         ...
         if(!param6)
         {
            _loc15_ = §_-w4K§.§_-73W§(_loc11_,_loc12_,param7);
            if(_loc15_ == null)
            {
               if(§_-w4K§.§_-l11§.numChildren > 0)
               {
               ...
               return §_-w4K§.§_-w1L§(param1,param2 / 2,param3,param4,param5,param6,false);
            }
         }
         else
         {
            _loc15_ = §_-w4K§.§_-53N§(_loc11_,_loc12_);
         }
         if(param4 != null)
         {
            ...
            while(_loc18_ < _loc19_)
            {
               ...
               {
                  _loc22_ = _loc21_;
                  _loc23_ = §_-w4K§.§_-P5T§(_loc22_.color,param5,param4);
                  if(_loc23_ != 0)
                  {
               ...
               {
                  _loc24_ = _loc21_;
                  _loc23_ = §_-w4K§.§_-P5T§(uint(_loc24_.colors[0]) & 0xFFFFFF,param5,param4);
                  _loc25_ = §_-w4K§.§_-P5T§(uint(_loc24_.colors[1]) & 0xFFFFFF,param5,param4);
                  if(_loc23_ != 0)
                  {
            ...
            §_-w4K§.§_-CN§.graphics.clear();
            §_-w4K§.§_-CN§.graphics.drawGraphicsData(_loc16_);
            _loc15_.draw(§_-w4K§.§_-CN§,_loc13_,_loc14_,null,null,true);
         }
         else
         {
      ...
      public static function §_-73W§(param1:int, param2:int, param3:Boolean) : BitmapData
      {
      ...
      public static function §_-W4T§(param1:Sprite, param2:uint) : Vector.<IGraphicsData>
      {
         var _loc6_:int = 0;
      ...
      public static function §_-s5m§(param1:DisplayObject) : Bitmap
      {
         if(param1.parent == null)
         {
            §_-w4K§.§_-pq§.addChild(param1);
         }
         ...
         _loc7_.x = _loc3_;
         _loc7_.y = _loc4_;
         var _loc8_:BitmapData = §_-w4K§.§_-53N§(_loc5_,_loc6_);
         ...
         _loc7_.bitmapData.copyPixels(_loc8_,_loc10_,§_-w4K§.§_-03h§,null,null,false);
         _loc7_.x += _loc10_.x;
         _loc7_.y += _loc10_.y;
         if(§_-w4K§.§_-pq§.numChildren > 0)
         {
            §_-w4K§.§_-pq§.removeChild(param1);
         }
         return _loc7_;
      }
      
      public static function §_-X24§(param1:DisplayObject) : Boolean
      {
         if(param1.parent == null)
         {
            §_-w4K§.§_-pq§.addChild(param1);
      ...
      public static function §_-m1S§(param1:Sprite, param2:Number) : Boolean
      {
         if(param1.parent == null)
         {
            §_-w4K§.§_-l11§.addChild(param1);
