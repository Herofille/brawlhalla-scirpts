   ...
   public class §_-Q4W§
   {
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            if(_loc8_.§_-F2V§() && _loc10_ != null && _loc10_.mDuration != 0)
            {
               ...
               else if(uint(param1 + 2500) > _loc11_)
               {
                  ...
                  {
                     _loc8_.§_-X2§.§_-D3B§(16777215,6710886);
                  }
               }
               else
               {
      ...
      public function §_-D4Y§(param1:uint) : void
      {
         ...
         if(§_-k2A§.§_-D4M§ == 0)
         {
            _loc4_ = §_-k2A§;
            _loc7_ = 32768;
            if(!((_loc4_.§_-d3H§ & _loc7_) != 0 || (_loc4_.§_-d3H§ & 0x20) != 0 && (_loc4_.§_-i1M§ & _loc7_) != 0))
            {
               if(_loc4_.§_-E4g§ == 2)
               {
                  _loc8_ = 16;
      ...
      public function §_-DL§(param1:uint, param2:ItemType, param3:Number = 1.79769313486231e+308, param4:Number = 1.79769313486231e+308, param5:uint = 4) : §_-o3n§
      {
         ...
         if(param3 == 1.79769313486231e+308 || param4 == 1.79769313486231e+308)
         {
            ...
            while(!§_-k2A§.§_-J4L§.§_-06h§(_loc8_,param1) && _loc9_ < _loc7_);
         ...
         §_-c3O§(_loc12_);
         if(§_-k2A§.§_-3A§ != null && (§_-k2A§.§_-d3H§ & 0x400006) != 0 && §_-k2A§.§_-u2A§ != 0 && param1 > §_-k2A§.§_-u2A§)
         {
         ...
         while(_loc6_ < 2)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(!(_loc5_ == null || int(_loc5_.length) == 0))
               {
                  ...
                  {
                     _loc14_ = _loc12_++;
                     if(!(_loc5_[_loc14_].§_-I3u§ && (§_-k2A§.§_-b42§.§_-X1f§ & 0x40) == 0))
                     {
