   ...
   public class §_-i1f§
   {
         ...
         switch(int(_loc1_))
         {
            ...
            case 3:
               ...
               if(_loc10_ != null)
               {
                  ...
                  §_-c2N§ = true;
                  §_-M3z§ = true;
                  §_-i4p§ = §_-13q§.§_-nH§(0,_loc10_.§_-T3s§,360) * §_-13q§.§_-e3Q§;
      ...
      public function §_-q3T§(param1:uint) : Boolean
      {
         ...
         if(§_-Y4§ < _loc7_)
         {
            ...
            if(§_-43A§ != null && (§_-h29§.§_-c2u§ & 0x0400) == 0)
            {
               _loc9_ = §_-43A§.§_-RU§();
               _loc10_ = §_-43A§.§_-y1u§;
               _loc11_ = _loc8_.§_-sd§;
            ...
            if(_loc3_ >= _loc17_)
            {
               if(_loc8_.§_-v3§)
               {
                  ...
                  if(!§_-k2A§.§_-m2U§ && !§_-k2A§.§_-v2c§ && §_-k2A§.§_-Vw§ == 0 && !((§_-k2A§.§_-d3H§ & 0x2C00) != 0 && §_-c1x§.§_-nD§.§_-b1R§ != 0))
                  {
         ...
         if(!§_-824§ && _loc14_)
         {
            ...
            while(_loc25_ < _loc24_)
            {
               ...
               _loc35_ = §_-k2A§;
               _loc29_ = 32768;
               if(!((_loc35_.§_-d3H§ & _loc29_) != 0 || (_loc35_.§_-d3H§ & 0x20) != 0 && (_loc35_.§_-i1M§ & _loc29_) != 0))
               {
                  if(_loc35_.§_-E4g§ == 2)
                  {
                     _loc36_ = 16;
            ...
            if(§_-h29§.§_-y3w§ != 4294967295 && §_-h29§.§_-y3w§ == §_-i2L§)
            {
      ...
      public function §_-J1W§(param1:uint) : Boolean
      {
         ...
         if(§_-h29§.§_-g3o§)
         {
            if((§_-M24§ & 0x0800) == 0 && §_-43A§.§_-W5p§.§_-9q§ != 3)
            {
               §_-M24§ |= 2048;
               _loc2_ = §_-k2A§;
               if((_loc2_.§_-d3H§ & 0x400006) != 0 && _loc2_.§_-3A§ != null && _loc2_.§_-PU§ == 1)
               {
      ...
      {
         if((§_-M24§ & 0x0800) != 0 || §_-W5B§ || §_-h29§.§_-72Q§)
         {
            return false;
         }
         var _loc2_:uint = uint(int(Math.round((uint(param1 - param1 % 16)) / 16)));
      ...
      public function §_-o56§(param1:uint, param2:uint, param3:uint, param4:Boolean) : uint
      {
         ...
         if(§_-h29§.§_-t4R§)
         {
            if((§_-43A§.§_-qj§.§_-l3y§ & 2) != 0)
            {
               if(§_-43A§.§_-OL§ != null)
               {
                  _loc5_ = param1 >= uint(§_-43A§.§_-H4F§ + 48);
               }
               else
               {
                  _loc5_ = false;
         ...
         if(§_-Tf§ == 0)
         {
            ...
            if(§_-h29§ != null && !§_-h29§.§_-75n§)
            {
               ...
               if(§_-k2A§.§_-3A§ != null && (§_-k2A§.§_-d3H§ & 0x400006) != 0)
               {
                  ...
                  {
                     _loc8_ = §_-k2A§;
                     if((_loc8_.§_-d3H§ & 0x400006) != 0 && _loc8_.§_-3A§ != null)
                     {
               ...
               if(!§_-T1S§.§_-eN§ && §_-T1S§.§_-43F§ && !§_-T1S§.§_-v54§)
               {
                  ...
                  if(_loc10_ != null)
                  {
                     ...
                     _loc12_ = §_-43A§;
                     _loc9_ = uint(_loc12_.§_-k2A§.§_-m5s§ == _loc12_ ? §_-f2T§.§_-O0§ : int(4294967295));
      ...
      public function §_-b3o§(param1:uint) : void
      {
         ...
         {
            if(param1 <= uint(§_-Tf§ + §_-h29§.§_-L2i§ + 10))
            {
               return;
            }
         }
