package
{
   public class §_-D4F§
   {
      ...
      public var mCache:Vector.<§_-E3U§> = new Vector.<§_-E3U§>();
      
      public function §_-D4F§()
      {
         §_-g1d§();
      }
      
      public function Store(param1:§_-E3U§, param2:int = -1) : int
      {
         var _loc3_:* = null as §_-E3U§;
         if(param2 >= 0)
         {
            _loc3_ = §_-e2f§(param2);
      ...
      {
         var _loc2_:§_-E3U§ = mCache[param1];
         if(_loc2_ != null)
         {
            --§_-O1O§;
      ...
      public function §_-T2x§(param1:int, param2:Boolean = true) : Boolean
      {
         ...
         var _loc3_:§_-E3U§ = mCache[param1];
         if(_loc3_ == null || !_loc3_.CanPrune(param2))
         {
            return false;
         }
         var _loc4_:§_-E3U§ = mCache[param1];
         if(_loc4_ != null)
         {
            --§_-O1O§;
      ...
      public function §_-L3q§(param1:int, param2:Boolean) : int
      {
         ...
         var _loc10_:* = null as §_-E3U§;
         var _loc11_:* = null as §_-E3U§;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
      ...
      public function §_-e2f§(param1:int) : §_-E3U§
      {
         if(param1 < 0 || param1 >= int(mCache.length))
         {
            return null;
