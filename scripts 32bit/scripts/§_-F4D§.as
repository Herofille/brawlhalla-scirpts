package
{
   ...
   public class §_-F4D§
   {
      ...
      public var §_-Q2U§:IMap = new StringMap();
      ...
      public function §_-F4D§(param1:§_-a1A§, param2:uint)
      {
         mScreen = param1;
         §_-81d§(mScreen.§_-81G§);
      ...
      {
         if(§_-H5d§ && !§_-F4D§.§_-LR§ && (§_-wd§ != null || §_-d1I§ != null || §_-F2c§ != null || §_-c25§ != null))
         {
      ...
      public function §_-j1r§(param1:§_-k4L§, param2:Number, param3:Number, param4:Number, param5:HeroType = undefined) : void
      {
         ...
         var _loc14_:* = null as §_-r4W§;
         var _loc15_:* = null as §_-l54§;
         var _loc16_:* = null as §_-U4d§;
         var _loc17_:* = null as §_-z7§;
         var _loc18_:Boolean = false;
         var _loc19_:* = null as §_-g1L§;
         if(§_-3X§.§_-y3x§())
         {
            param4 *= 0.75;
         }
         ...
         {
            _loc9_ = §_-61Q§.§_-e5s§(param1.§_-QJ§);
            §_-X4A§(§_-X6§,_loc9_,param5);
         }
         else if(_loc7_ == "Companion")
         {
            _loc10_ = CompanionType.§_-g4K§.get(param1.§_-QJ§);
            §_-c46§.§_-Xn§(§_-X6§,_loc10_,"Ready");
            §_-w1N§(_loc10_.mDisplayNameKey);
         }
         else if(_loc7_ == "Costume")
         {
            _loc11_ = CostumeType.§_-a3v§(param1.§_-QJ§);
            §_-h3W§(_loc11_);
            if(_loc11_.§_-r2Z§.mHeroName == "Soldier")
            {
               §_-X6§.§_-t4v§(§_-X6§.§_-lA§ - 50,§_-X6§.§_-I4e§);
            }
            if(§_-H5d§ && _loc11_.§_-73R§ != null)
            {
               §_-wd§ = _loc11_;
               §_-aQ§ = §_-G2r§.§_-B4H§;
               §_-kt§ = 2500;
            ...
            if(§_-ft§ != null)
            {
               _loc11_.§_-r2Z§.§_-04q§(§_-G2r§,_loc11_,§_-ft§);
            }
         }
         else if(_loc7_ == "KOEffect")
         {
            _loc12_ = §_-z1a§.§_-T3y§(param1.§_-QJ§);
            §_-c46§.§_-r5S§(§_-X6§,_loc12_);
            §_-w1N§(_loc12_.mDisplayNameKey);
            if(§_-ft§ != null)
            {
               _loc12_.§_-Y1V§(§_-G2r§,§_-ft§);
            }
         }
         else if(_loc7_ == "PlayerTheme")
         {
            §_-X6§.§_-t4v§(§_-X6§.§_-lA§ - 30,§_-X6§.§_-I4e§);
            _loc13_ = §_-Af§.§_-J57§(param1.§_-QJ§);
            §_-c46§.§_-A1d§(§_-X6§,_loc13_,"StoreAllItems");
            §_-w1N§(_loc13_.mDisplayNameKey);
         }
         else if(_loc7_ == "Podium")
         {
            _loc14_ = §_-r4W§.§_-o10§(param1.§_-QJ§);
            §_-436§(_loc14_);
            if(§_-H5d§ && _loc14_.§_-73R§ != null)
            {
               §_-d1I§ = _loc14_;
               §_-aQ§ = §_-G2r§.§_-B4H§;
               §_-kt§ = 3000;
         ...
         {
            _loc15_ = §_-l54§.§_-B45§(param1.§_-QJ§);
            §_-c46§.§_-g1I§(§_-X6§,_loc15_,"Ready");
            §_-w1N§(_loc15_.mDisplayNameKey);
         }
         else if(_loc7_ == "Taunt")
         {
            _loc16_ = §_-U4d§.§_-ks§.get(param1.§_-QJ§);
            §_-c46§.§_-L5G§(§_-X6§,_loc16_,1,CostumeType.§_-93R§,null,null,true,true);
            _loc17_ = §_-z7§.§_-75o§(_loc16_.§_-42I§);
            _loc18_ = _loc17_.§_-F3Z§;
            if(_loc18_)
            {
               §_-c25§ = _loc16_;
               §_-aQ§ = §_-G2r§.§_-B4H§;
            ...
            §_-w1N§(_loc16_.mDisplayNameKey);
            if(§_-ft§ != null)
            {
               _loc16_.§_-t59§(§_-G2r§,false,§_-ft§);
            }
         }
         else if(_loc7_ == "WeaponSkin")
         {
            _loc19_ = §_-g1L§.§_-J1X§(param1.§_-QJ§);
            §_-c46§.§_-G24§(§_-X6§,_loc19_);
            §_-w1N§(_loc19_.mDisplayNameKey);
            §_-15w§(param1.§_-N5J§(),§_-f4c§.§_-72v§(§_-g1L§.§_-F1H§(_loc19_.§_-i38§)) + " ");
         }
      }
      
      public function §_-C1P§(param1:§_-k4L§, param2:Number, param3:Number, param4:Number) : void
      {
         §_-tv§(param1.mType,param1.§_-QJ§,param1.§_-N2C§,§_-k4L§.§_-n2b§.get(param1.mType),"UI_BattlePass",param2,param3,param4);
      }
      ...
      public function §_-93f§(param1:§_-k4L§, param2:Number, param3:Number, param4:Number) : void
      {
      ...
      public function §_-z2H§(param1:§_-k4L§, param2:Number, param3:Number, param4:Number) : void
      {
      ...
      public function §_-b15§(param1:IMap) : void
      {
      ...
      public function §_-N4o§(param1:String, param2:Float3) : void
      {
         §_-ha§ = false;
         var _loc3_:StringMap = §_-Q2U§;
      ...
      public function §_-624§(param1:§_-k4L§, param2:HeroType = undefined) : void
      {
         ...
         if(§_-j1q§ != null && §_-j1q§.§_-T8§(param1))
         {
            return;
         }
         §_-j1q§ = param1;
         if(param2 == null && param1.mType == "RandomColor" && §_-F2c§ != null && §_-F2c§.mColorSchemeName == param1.§_-QJ§)
         {
            return;
         }
         Clear(false);
         var _loc3_:String = param1.§_-N5J§();
         if(_loc3_ == null)
         {
            _loc3_ = "Empty_String";
         }
         §_-15w§(_loc3_,null,null);
         var _loc4_:Float3 = §_-z3q§(param1);
         var _loc5_:String = param1.mType;
         var _loc6_:String = _loc5_;
         if(_loc6_ == "Avatar")
         {
            §_-z2H§(param1,_loc4_.x,_loc4_.y,_loc4_.z);
         }
         else if(_loc6_ == "ColorScheme")
         {
            §_-j1r§(param1,_loc4_.x,_loc4_.y,_loc4_.z,param2);
         }
         else if(_loc6_ == "Emoji")
         {
            §_-93f§(param1,_loc4_.x,_loc4_.y,_loc4_.z);
         }
         else
         {
            if(_loc6_ != "Gold")
            ...
            _loc8_ = _loc4_.y;
            _loc9_ = _loc4_.z;
            §_-tv§(param1.mType,param1.§_-QJ§,param1.§_-N2C§,§_-k4L§.§_-n2b§.get(param1.mType),"UI_BattlePass",_loc7_,_loc8_,_loc9_);
         }
      }
      ...
      public function §_-z3q§(param1:§_-k4L§) : Float3
      {
         var _loc3_:* = null as String;
         ...
         {
            _loc7_ = §_-U4d§.§_-ks§.get(param1.§_-QJ§);
            if(_loc7_ != null)
            {
               if(_loc7_.§_-L5I§ != null)
               {
                  _loc2_.x += _loc7_.§_-L5I§.x;
                  _loc2_.y += _loc7_.§_-L5I§.y;
               }
            }
         }
         if(_loc2_.z < 0.1)
      ...
      public function §_-S5u§(param1:§_-k4L§) : void
      {
