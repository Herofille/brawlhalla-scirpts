               ...
               else
               {
                  ...
                  while(_loc43_ < _loc49_)
                  {
                     ...
                     if(_loc50_)
                     {
                        ...
                        {
                           _loc47_ = _loc50_[0].charCodeAt(_loc46_) - "x".charCodeAt(0);
                           if(_loc47_ > 2)
                           {
                              _loc47_ = 3;
                           }
                     ...
                     if(_loc25_)
                     {
                        ...
                        _loc45_ = _loc37_[0].charCodeAt(1) - "x".charCodeAt(0);
                        if(_loc45_ > 2)
                        {
                           _loc45_ = 3;
                        }
                     ...
                     else
                     {
                        ...
                        agalcode.writeShort(_loc25_ ? _loc45_ | 0x8000 : 0);
                        _loc8_ -= 64;
                     }
                     _loc43_++;
                  }
