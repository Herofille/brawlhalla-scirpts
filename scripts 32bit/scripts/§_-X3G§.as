package
{
   ...
   public class §_-X3G§ extends §_-a1A§
   {
      ...
      public function §_-X3G§(param1:§_-oF§)
      {
      ...
      public function §_-u56§() : void
      {
         ...
         §_-u3Z§.§_-01K§(§_-X3G§.§_-Yz§.h[§_-p4Z§]);
         §_-u3Z§.§_-X3v§();
      }
      ...
      {
         §_-13N§.§_-K4c§("TauntType_Unknown_DisplayName");
         §_-p46§.§_-K4c§("TauntType_Unknown_DisplayName");
         §_-k1b§.§_-Z2C§("Ready");
         §_-k1b§.§_-01K§("Empty");
         §_-Rc§.§_-81L§(false);
         §_-Q2O§.§_-81L§(false);
         ...
         §_-13N§.§_-K4c§(§_-Y2W§.§_-n51§);
         §_-p46§.§_-K4c§(§_-Y2W§.§_-c2F§);
         var _loc1_:StoreType = StoreType.§_-G4Z§.get(§_-Y2W§.§_-Q1s§);
         if(_loc1_ == null)
         {
            return;
         }
         §_-l2j§ = true;
         var _loc2_:Boolean = §_-G2r§.§_-42q§.§_-r2f§(_loc1_);
         if(_loc2_)
         {
            §_-k1b§.§_-01K§("Unlocked");
         }
         else if(§_-l2j§)
         {
            §_-k1b§.§_-F1S§();
         ...
         {
            §_-u8§ = §_-c53§(§_-Y2W§.§_-z32§,§_-Q2O§,§_-u8§);
            §_-k1b§.§_-01K§("ConsoleReady");
            §_-u3Z§.§_-81L§(false);
         }
         §_-f1V§ = §_-c53§(§_-Y2W§.§_-s3X§,§_-Rc§,§_-f1V§);
         §_-314§.§_-K4c§(_loc1_.mDisplayNameKey);
         §_-u56§();
      }
      ...
      override public function §_-a3D§() : void
      {
         ...
         §_-92g§ = §_-Y1U§(§_-d4S§.§_-n1D§(§_-k1b§.§_-r1l§,"am_TextClaimSkin"),"am_Text","UI_SocialWeapons_Claim",§_-u2k§.§_-f3N§);
      ...
      {
         var _loc3_:String = §_-Y2W§ != null ? §_-Y2W§.§_-I3B§(0) : null;
         if(_loc3_ != null)
         {
            §_-oF§.§_-a5G§(_loc3_);
         }
