package
{
   ...
   public class DevSettings
   {
      ...
      public static function ConfigLoaded(param1:§_-d2e§) : void
      {
         ...
         var _loc15_:* = null as §_-y2Y§;
         var _loc2_:§_-s4G§ = §_-s4G§.parse(param1.§_-TI§());
         var _loc3_:§_-s4G§ = _loc2_.§_-D1w§();
         var _loc4_:* = _loc3_.§_-m4B§();
         while(Boolean(_loc4_.hasNext()))
         {
            ...
            _loc6_ = _loc5_.§_-vJ§.toUpperCase();
            _loc7_ = _loc6_;
            ...
            {
               DevSettings.sOfflineBattlePassSeason = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
            }
            ...
            else
            {
               if(_loc7_ != "AVATAR")
               {
                  if(_loc7_ != "DEFAULTAVATAR")
                  {
                     ...
                     {
                        DevSettings.defaultEntitlementUnlock = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                     }
                     ...
                     else
                     {
                        if(_loc7_ != "DEFAULTKOEFFECT")
                        {
                           if(_loc7_ != "DEFAULTTRAILEFFECT")
                           {
                              ...
                              {
                                 DevSettings.defaultPromoTypeUnlock = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                              }
                              ...
                              {
                                 DevSettings.defaultStoreTypeUnlock = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                              }
                              else
                              {
                                       ...
                                       else
                                       {
                                          if(_loc7_ != "BATTLEPASSEDIT")
                                          {
                                             if(_loc7_ != "EDITBATTLEPASS")
                                             {
                                                ...
                                                {
                                                   DevSettings.gameSpeed = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                                                }
                                                else
                                                {
                                                         ...
                                                         if(_loc7_ != "LESSONEDIT")
                                                         {
                                                            if(_loc7_ != "LESSONEDITOR")
                                                            {
                                                               if(_loc7_ != "TUTORIALEDITOR")
                                                               {
                                                                  ...
                                                                  {
                                                                     DevSettings.levelOverrideStartFrame = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                                                                  }
                                                                  else
                                                                  {
                                                                     if(_loc7_ != "LOADNEXTBATTLEPASS")
                                                                     {
                                                                        if(_loc7_ != "NEXT")
                                                                        {
                                                                           if(_loc7_ != "NEXTBATTLEPASS")
                                                                           {
                                                                              ...
                                                                              {
                                                                                 DevSettings.playerLimit = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                                                                              }
                                                                              ...
                                                                              else if(_loc7_ == "PLAYERSPAWNPOINTS")
                                                                              {
                                                                                 ...
                                                                                 while(_loc9_ < _loc10_)
                                                                                 {
                                                                                    ...
                                                                                    {
                                                                                       _loc13_ = §_-s5a§.parseInt(_loc12_[0]);
                                                                                       _loc14_ = _loc12_[1].split(",");
                                                                                       if(int(_loc14_.length) == 2)
                                                                                       {
                                                                                          _loc15_ = new §_-y2Y§(§_-s5a§.parseFloat(_loc14_[0]),§_-s5a§.parseFloat(_loc14_[1]));
                                                                              ...
                                                                              {
                                                                                 DevSettings.playersToTrack = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                                                                              }
                                                                                    ...
                                                                                    if(_loc7_ != "LESSONTEST")
                                                                                    {
                                                                                       if(_loc7_ != "TESTLESSON")
                                                                                       {
                                                                                          if(_loc7_ != "TESTLESSONS")
                                                                                          {
                                                                                             ...
                                                                                             {
                                                                                                DevSettings.videoCaptureConfig = uint(_loc5_ != null && _loc5_.exists("value") ? §_-s5a§.parseInt(_loc5_.get("value")) : int(0));
                                                                                             }
                                                                                             else if(§_-h5V§.§_-D3O§(DevSettings,_loc6_) != null)
                                                                                             {
                                                                                                _loc13_ = §_-h5V§.§_-D3O§(DevSettings,_loc6_);
      ...
      public static function Initialize() : void
      {
         ...
         while(_loc1_ < int(_loc2_.length))
         {
            ...
            if(_loc3_ != 0)
            {
               §_-22E§.§_-m1v§("Failed to start the client");
            }
         }
      }
      ...
      {
         return §_-xN§.§_-C5p§(DevSettings.flags,param1);
      }
      
      public static function SetDevFlag(param1:uint) : void
      {
         §_-xN§.§_-U5y§(DevSettings.flags,param1);
      }
      ...
      {
         §_-xN§.§_-CT§(DevSettings.flags,param1);
      }
